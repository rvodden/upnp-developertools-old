...
namespace OpenSource.UPnP
{
    ...
    public sealed class UPnPControlPoint
    {
        ...
        {
            OpenSource.Utilities.EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, "Finding Devices Asynchronously on End Point : " + RemoteEP.ToString());
        ...
        {
            OpenSource.Utilities.EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, "Received ASync Result");
            IPEndPoint ep = null;
        ...
        private void OnReceiveSink2(byte[] buffer, IPEndPoint remote, IPEndPoint local)
        {
            ...
            try
            {
                OpenSource.Utilities.EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, "Received ASync Result from : " + remote.Address.ToString());
            ...
            OpenSource.Utilities.EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, "Device Location : " + Location);
            int MaxAge = 0;
            ...
            OpenSource.Utilities.EventLogger.Log(this, System.Diagnostics.EventLogEntryType.SuccessAudit, "Potential New Device : " + msg.RemoteEndPoint.ToString());
